...
O projeto é a codificação de um aplicativo calculadora para Android criando-se funções nativas.

### Iniciando...

- `git clone https://github.com/rayssasandrade/calculator.git`
- `cd calculator`
- `flutter run`
